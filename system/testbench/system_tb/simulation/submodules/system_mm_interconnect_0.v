...
module system_mm_interconnect_0 (
		...
		input  wire        spi_slave_reset_reset_bridge_in_reset_reset,    //    spi_slave_reset_reset_bridge_in_reset.reset
	...
	wire  [31:0] spi_slave_spi_control_port_agent_m0_readdata;                                       // spi_slave_spi_control_port_translator:uav_readdata -> spi_slave_spi_control_port_agent:m0_readdata
	wire         spi_slave_spi_control_port_agent_m0_waitrequest;                                    // spi_slave_spi_control_port_translator:uav_waitrequest -> spi_slave_spi_control_port_agent:m0_waitrequest
	wire         spi_slave_spi_control_port_agent_m0_debugaccess;                                    // spi_slave_spi_control_port_agent:m0_debugaccess -> spi_slave_spi_control_port_translator:uav_debugaccess
	wire  [16:0] spi_slave_spi_control_port_agent_m0_address;                                        // spi_slave_spi_control_port_agent:m0_address -> spi_slave_spi_control_port_translator:uav_address
	wire   [3:0] spi_slave_spi_control_port_agent_m0_byteenable;                                     // spi_slave_spi_control_port_agent:m0_byteenable -> spi_slave_spi_control_port_translator:uav_byteenable
	wire         spi_slave_spi_control_port_agent_m0_read;                                           // spi_slave_spi_control_port_agent:m0_read -> spi_slave_spi_control_port_translator:uav_read
	wire         spi_slave_spi_control_port_agent_m0_readdatavalid;                                  // spi_slave_spi_control_port_translator:uav_readdatavalid -> spi_slave_spi_control_port_agent:m0_readdatavalid
	wire         spi_slave_spi_control_port_agent_m0_lock;                                           // spi_slave_spi_control_port_agent:m0_lock -> spi_slave_spi_control_port_translator:uav_lock
	wire  [31:0] spi_slave_spi_control_port_agent_m0_writedata;                                      // spi_slave_spi_control_port_agent:m0_writedata -> spi_slave_spi_control_port_translator:uav_writedata
	wire         spi_slave_spi_control_port_agent_m0_write;                                          // spi_slave_spi_control_port_agent:m0_write -> spi_slave_spi_control_port_translator:uav_write
	wire   [2:0] spi_slave_spi_control_port_agent_m0_burstcount;                                     // spi_slave_spi_control_port_agent:m0_burstcount -> spi_slave_spi_control_port_translator:uav_burstcount
	wire         spi_slave_spi_control_port_agent_rf_source_valid;                                   // spi_slave_spi_control_port_agent:rf_source_valid -> spi_slave_spi_control_port_agent_rsp_fifo:in_valid
	wire  [93:0] spi_slave_spi_control_port_agent_rf_source_data;                                    // spi_slave_spi_control_port_agent:rf_source_data -> spi_slave_spi_control_port_agent_rsp_fifo:in_data
	wire         spi_slave_spi_control_port_agent_rf_source_ready;                                   // spi_slave_spi_control_port_agent_rsp_fifo:in_ready -> spi_slave_spi_control_port_agent:rf_source_ready
	wire         spi_slave_spi_control_port_agent_rf_source_startofpacket;                           // spi_slave_spi_control_port_agent:rf_source_startofpacket -> spi_slave_spi_control_port_agent_rsp_fifo:in_startofpacket
	wire         spi_slave_spi_control_port_agent_rf_source_endofpacket;                             // spi_slave_spi_control_port_agent:rf_source_endofpacket -> spi_slave_spi_control_port_agent_rsp_fifo:in_endofpacket
	wire         spi_slave_spi_control_port_agent_rsp_fifo_out_valid;                                // spi_slave_spi_control_port_agent_rsp_fifo:out_valid -> spi_slave_spi_control_port_agent:rf_sink_valid
	wire  [93:0] spi_slave_spi_control_port_agent_rsp_fifo_out_data;                                 // spi_slave_spi_control_port_agent_rsp_fifo:out_data -> spi_slave_spi_control_port_agent:rf_sink_data
	wire         spi_slave_spi_control_port_agent_rsp_fifo_out_ready;                                // spi_slave_spi_control_port_agent:rf_sink_ready -> spi_slave_spi_control_port_agent_rsp_fifo:out_ready
	wire         spi_slave_spi_control_port_agent_rsp_fifo_out_startofpacket;                        // spi_slave_spi_control_port_agent_rsp_fifo:out_startofpacket -> spi_slave_spi_control_port_agent:rf_sink_startofpacket
	wire         spi_slave_spi_control_port_agent_rsp_fifo_out_endofpacket;                          // spi_slave_spi_control_port_agent_rsp_fifo:out_endofpacket -> spi_slave_spi_control_port_agent:rf_sink_endofpacket
	wire         cmd_mux_003_src_valid;                                                              // cmd_mux_003:src_valid -> spi_slave_spi_control_port_agent:cp_valid
	wire  [92:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> spi_slave_spi_control_port_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                              // spi_slave_spi_control_port_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [4:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> spi_slave_spi_control_port_agent:cp_channel
	wire         cmd_mux_003_src_startofpacket;                                                      // cmd_mux_003:src_startofpacket -> spi_slave_spi_control_port_agent:cp_startofpacket
	wire         cmd_mux_003_src_endofpacket;                                                        // cmd_mux_003:src_endofpacket -> spi_slave_spi_control_port_agent:cp_endofpacket
	...
	wire  [16:0] spi_master_spi_control_port_agent_m0_address;                                       // spi_master_spi_control_port_agent:m0_address -> spi_master_spi_control_port_translator:uav_address
	...
	wire  [93:0] spi_master_spi_control_port_agent_rf_source_data;                                   // spi_master_spi_control_port_agent:rf_source_data -> spi_master_spi_control_port_agent_rsp_fifo:in_data
	...
	wire  [93:0] spi_master_spi_control_port_agent_rsp_fifo_out_data;                                // spi_master_spi_control_port_agent_rsp_fifo:out_data -> spi_master_spi_control_port_agent:rf_sink_data
	...
	wire         cmd_mux_004_src_valid;                                                              // cmd_mux_004:src_valid -> spi_master_spi_control_port_agent:cp_valid
	wire  [92:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> spi_master_spi_control_port_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                              // spi_master_spi_control_port_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [4:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> spi_master_spi_control_port_agent:cp_channel
	wire         cmd_mux_004_src_startofpacket;                                                      // cmd_mux_004:src_startofpacket -> spi_master_spi_control_port_agent:cp_startofpacket
	wire         cmd_mux_004_src_endofpacket;                                                        // cmd_mux_004:src_endofpacket -> spi_master_spi_control_port_agent:cp_endofpacket
	...
	wire         spi_slave_spi_control_port_agent_rp_valid;                                          // spi_slave_spi_control_port_agent:rp_valid -> router_005:sink_valid
	wire  [92:0] spi_slave_spi_control_port_agent_rp_data;                                           // spi_slave_spi_control_port_agent:rp_data -> router_005:sink_data
	wire         spi_slave_spi_control_port_agent_rp_ready;                                          // router_005:sink_ready -> spi_slave_spi_control_port_agent:rp_ready
	wire         spi_slave_spi_control_port_agent_rp_startofpacket;                                  // spi_slave_spi_control_port_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire         spi_slave_spi_control_port_agent_rp_endofpacket;                                    // spi_slave_spi_control_port_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire         spi_master_spi_control_port_agent_rp_valid;                                         // spi_master_spi_control_port_agent:rp_valid -> router_006:sink_valid
	wire  [92:0] spi_master_spi_control_port_agent_rp_data;                                          // spi_master_spi_control_port_agent:rp_data -> router_006:sink_data
	wire         spi_master_spi_control_port_agent_rp_ready;                                         // router_006:sink_ready -> spi_master_spi_control_port_agent:rp_ready
	wire         spi_master_spi_control_port_agent_rp_startofpacket;                                 // spi_master_spi_control_port_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire         spi_master_spi_control_port_agent_rp_endofpacket;                                   // spi_master_spi_control_port_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire         spi_slave_spi_control_port_agent_rdata_fifo_src_valid;                              // spi_slave_spi_control_port_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire  [33:0] spi_slave_spi_control_port_agent_rdata_fifo_src_data;                               // spi_slave_spi_control_port_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire         spi_slave_spi_control_port_agent_rdata_fifo_src_ready;                              // avalon_st_adapter_003:in_0_ready -> spi_slave_spi_control_port_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_003_out_0_valid;                                                  // avalon_st_adapter_003:out_0_valid -> spi_slave_spi_control_port_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_003_out_0_data;                                                   // avalon_st_adapter_003:out_0_data -> spi_slave_spi_control_port_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_003_out_0_ready;                                                  // spi_slave_spi_control_port_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire   [0:0] avalon_st_adapter_003_out_0_error;                                                  // avalon_st_adapter_003:out_0_error -> spi_slave_spi_control_port_agent:rdata_fifo_sink_error
	wire         spi_master_spi_control_port_agent_rdata_fifo_src_valid;                             // spi_master_spi_control_port_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] spi_master_spi_control_port_agent_rdata_fifo_src_data;                              // spi_master_spi_control_port_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire         spi_master_spi_control_port_agent_rdata_fifo_src_ready;                             // avalon_st_adapter_004:in_0_ready -> spi_master_spi_control_port_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_004_out_0_valid;                                                  // avalon_st_adapter_004:out_0_valid -> spi_master_spi_control_port_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_004_out_0_data;                                                   // avalon_st_adapter_004:out_0_data -> spi_master_spi_control_port_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_004_out_0_ready;                                                  // spi_master_spi_control_port_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire   [0:0] avalon_st_adapter_004_out_0_error;                                                  // avalon_st_adapter_004:out_0_error -> spi_master_spi_control_port_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clock_clk_clk),                                     //                      clk.clk
		.reset                  (spi_slave_reset_reset_bridge_in_reset_reset),       //                    reset.reset
		.uav_address            (spi_slave_spi_control_port_agent_m0_address),       // avalon_universal_slave_0.address
		.uav_burstcount         (spi_slave_spi_control_port_agent_m0_burstcount),    //                         .burstcount
		.uav_read               (spi_slave_spi_control_port_agent_m0_read),          //                         .read
		.uav_write              (spi_slave_spi_control_port_agent_m0_write),         //                         .write
		.uav_waitrequest        (spi_slave_spi_control_port_agent_m0_waitrequest),   //                         .waitrequest
		.uav_readdatavalid      (spi_slave_spi_control_port_agent_m0_readdatavalid), //                         .readdatavalid
		.uav_byteenable         (spi_slave_spi_control_port_agent_m0_byteenable),    //                         .byteenable
		.uav_readdata           (spi_slave_spi_control_port_agent_m0_readdata),      //                         .readdata
		.uav_writedata          (spi_slave_spi_control_port_agent_m0_writedata),     //                         .writedata
		.uav_lock               (spi_slave_spi_control_port_agent_m0_lock),          //                         .lock
		.uav_debugaccess        (spi_slave_spi_control_port_agent_m0_debugaccess),   //                         .debugaccess
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) spi_slave_spi_control_port_agent (
		.clk                     (clock_clk_clk),                                               //             clk.clk
		.reset                   (spi_slave_reset_reset_bridge_in_reset_reset),                 //       clk_reset.reset
		.m0_address              (spi_slave_spi_control_port_agent_m0_address),                 //              m0.address
		.m0_burstcount           (spi_slave_spi_control_port_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (spi_slave_spi_control_port_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (spi_slave_spi_control_port_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (spi_slave_spi_control_port_agent_m0_lock),                    //                .lock
		.m0_readdata             (spi_slave_spi_control_port_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (spi_slave_spi_control_port_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (spi_slave_spi_control_port_agent_m0_read),                    //                .read
		.m0_waitrequest          (spi_slave_spi_control_port_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (spi_slave_spi_control_port_agent_m0_writedata),               //                .writedata
		.m0_write                (spi_slave_spi_control_port_agent_m0_write),                   //                .write
		.rp_endofpacket          (spi_slave_spi_control_port_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (spi_slave_spi_control_port_agent_rp_ready),                   //                .ready
		.rp_valid                (spi_slave_spi_control_port_agent_rp_valid),                   //                .valid
		.rp_data                 (spi_slave_spi_control_port_agent_rp_data),                    //                .data
		.rp_startofpacket        (spi_slave_spi_control_port_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (spi_slave_spi_control_port_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (spi_slave_spi_control_port_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (spi_slave_spi_control_port_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (spi_slave_spi_control_port_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (spi_slave_spi_control_port_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (spi_slave_spi_control_port_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (spi_slave_spi_control_port_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (spi_slave_spi_control_port_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (spi_slave_spi_control_port_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (spi_slave_spi_control_port_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_003_out_0_ready),                           // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_003_out_0_valid),                           //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_003_out_0_data),                            //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_003_out_0_error),                           //                .error
		.rdata_fifo_src_ready    (spi_slave_spi_control_port_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (spi_slave_spi_control_port_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (spi_slave_spi_control_port_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                                       //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                         //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) spi_slave_spi_control_port_agent_rsp_fifo (
		.clk               (clock_clk_clk),                                               //       clk.clk
		.reset             (spi_slave_reset_reset_bridge_in_reset_reset),                 // clk_reset.reset
		.in_data           (spi_slave_spi_control_port_agent_rf_source_data),             //        in.data
		.in_valid          (spi_slave_spi_control_port_agent_rf_source_valid),            //          .valid
		.in_ready          (spi_slave_spi_control_port_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (spi_slave_spi_control_port_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (spi_slave_spi_control_port_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (spi_slave_spi_control_port_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (spi_slave_spi_control_port_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (spi_slave_spi_control_port_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (spi_slave_spi_control_port_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (spi_slave_spi_control_port_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                                       // (terminated)
		.csr_read          (1'b0),                                                        // (terminated)
		.csr_write         (1'b0),                                                        // (terminated)
		.csr_readdata      (),                                                            // (terminated)
	...
	system_mm_interconnect_0_router_005 router_005 (
		.sink_ready         (spi_slave_spi_control_port_agent_rp_ready),         //      sink.ready
		.sink_valid         (spi_slave_spi_control_port_agent_rp_valid),         //          .valid
		.sink_data          (spi_slave_spi_control_port_agent_rp_data),          //          .data
		.sink_startofpacket (spi_slave_spi_control_port_agent_rp_startofpacket), //          .startofpacket
		.sink_endofpacket   (spi_slave_spi_control_port_agent_rp_endofpacket),   //          .endofpacket
		.clk                (clock_clk_clk),                                     //       clk.clk
		.reset              (spi_slave_reset_reset_bridge_in_reset_reset),       // clk_reset.reset
	...
	system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clock_clk_clk),                                         // in_clk_0.clk
		.in_rst_0_reset (spi_slave_reset_reset_bridge_in_reset_reset),           // in_rst_0.reset
		.in_0_data      (spi_slave_spi_control_port_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (spi_slave_spi_control_port_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (spi_slave_spi_control_port_agent_rdata_fifo_src_ready), //         .ready
